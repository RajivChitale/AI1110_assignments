...
%
\begin{equation}
    \text{var}\sbrak{U} = \mean{\brak{U- \mean{U}}^2} \end{equation}
...
\begin{align}
    \text{var}\sbrak{U} &= \mean{\brak{U- \mean{U}}^2} \\
    \text{var}\sbrak{U} &= \mean{\brak{U-0.5}^2} \\
    \text{var}\sbrak{U} &= \mean{U^2 - U + 0.25}  \\
    \text{var}\sbrak{U} &= \mean{U^2} - \mean{U} + \mean{0.25}  \\
...
To calculate variance we take k=2
\begin{align}
    \text{var}\sbrak{X} &= \mean{\brak{X- \mean{X}}^2} \\
    \text{var}\sbrak{X} &= \mean{X^2} \\
