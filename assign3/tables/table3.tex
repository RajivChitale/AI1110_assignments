...
\ifthenelse{\isundefined{\gnumericColD}}{\newlength{\gnumericColD}}{}\settowidth{\gnumericColD}{\begin{tabular}{@{}p{114pt*\gnumericScale}@{}}x\end{tabular}}
...
\hhline{|-|-|-|-}
	...
	{\gnumericPB{\centering}\gnumbox{\textbf{Points}}}
\\
\hhline{|----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|----|}
	...
	{\gnumericPB{\centering}\gnumbox{3}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}\gnumbox{\textbf{J}}}
\\
\hhline{|----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}\gnumbox{\textbf{K}}}
\\
\hhline{|----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	{\gnumericPB{\centering}\gnumbox{0}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}\gnumbox{\textbf{L}}}
\\
\hhline{|-|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{\textbf{51}}}
	&\multicolumn{1}{p{\gnumericColD}|}%
