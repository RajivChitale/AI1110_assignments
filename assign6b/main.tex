...
\providecommand{\res}[1]{\Res\displaygts_{#1}} 
...
\normalsize{} %just in case font size is stuck as small
...
\begin{align}
    \vec{Q_1} &= \myvec{\input{tables/table4.txt}} \\
    \vec{Q_t} &= \vec{Q_1} \vec{P}^{t-1}  
\end{align}
The limiting probabilities of states,
\begin{align}
   \lim_{t \to \infty}  \vec{Q_t} &= 
   \myvec{0 & 0 & 0 & 0.4 & 0.4 & 0 & 0 & 0 & 0.1 & 0.1}
\end{align}
%
