...
\hhline{|-|-}
	...
	{\gnumericPB{\centering}\gnumbox{Event $e_i$}}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|--|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$X_t= i \in \cbrak{1,2,4,5}  \land Y_t=0$}}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|--|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$X_t= i \in \cbrak{1,2,4,5} \land Y_t=1$}}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
