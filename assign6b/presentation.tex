...
\begin{frame}{Markov Chain}
    Let us construct a Markov chain $X_t$ with discrete time t. The states $e_0$, $e_1$ and $e_2$ describe the outcomes from the latest dice throw. The states $e_3$ and $e_4$ describe the outcomes of the latest coin toss.
\end{frame}
%%
\begin{frame}{States}
