...
%\begin{align}
%   & \pr{Z_1 = 1} \\
%    &= \sum_{n=1}^\infty \sum_{i \in \cbrak{1,2,4,5}}\pr{X_n = i} \times %\pr{Z_2 = 1} \\
%    &= \sum_{n=1}^\infty 4 \times \brak{\frac{1}{3}}^{n-1} %\brak{\frac{1}{6}} \times \pr{Z_2 = 1} \\
%    &= 4 \times \frac{3}{2} \times \frac{1}{6} \times \frac{1}{2} \\
%    &= \frac{1}{2} 
%\end{align}
%%
